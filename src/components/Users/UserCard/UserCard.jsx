  ...
  return (
    <div className={styles.userCard}>
      <div className={styles.avatarWrapper}>
        ...
        {props.user.followed 
        ? <button disabled={props.followingInProgress.some(id => id === props.user.id)} className={styles.followButton} onClick={() => { props.unfollow(props.user.id)}}>Unfollow</button>
        : <button disabled={props.followingInProgress.some(id => id === props.user.id)} className={styles.followButton} onClick={() => { props.follow(props.user.id)}}>Follow</button>
        }
      </div>
